  ...
  const chakras = [
    {
      ...
      details: "В этом классе мы проработаем корневую чакру через крии на укрепление ног, бёдер и таза. Вы почувствуете связь с землёй, обретёте уверенность и стабильность. Практика включает мощные дыхательные техники и медитацию на безопасность."
    },
    {
      name: "Свадхистана",
      ...
      details: "Динамичная практика для раскрытия сакральной чакры. Круговые движения бёдрами, танцевальные элементы и работа с эмоциями. Вы научитесь принимать свои чувства и активируете творческую энергию."
    },
    {
      name: "Манипура",
      ...
      details: "Интенсивный класс на укрепление пресса и проработку солнечного сплетения. Дыхание огня, упражнения на силу воли и медитация на внутренний огонь. Вы обретёте уверенность и способность действовать."
    },
    {
      name: "Анахата",
      ...
      details: "Мягкая и глубокая практика для раскрытия сердечного центра. Упражнения на раскрытие грудной клетки, работа с руками и медитация любящей доброты. Вы научитесь любить себя и других безусловно."
    },
    {
      name: "Вишудха",
      ...
      details: "Практика включает работу с голосом, мантры и упражнения на шею и плечи. Вы научитесь говорить свою правду, выражать себя свободно и слушать своё внутреннее знание."
    },
    {
      name: "Аджна",
      ...
      details: "Глубокая медитативная практика для активации третьего глаза. Концентрация на точке межбровья, визуализации и практики осознанности. Вы разовьёте интуицию и внутреннее видение."
    },
    {
      name: "Сахасрара",
      ...
      details: "Завершающий класс курса — медитация и практики для соединения с высшим сознанием. Вы интегрируете весь опыт семи классов и откроете связь с универсальной мудростью."
    }
  ];
              ...
              >
                <CardContent className="p-8 flex flex-col md:flex-row gap-6 items-start md:items-center">
                  ...
                  <Button 
                    ...
                    onClick={() => setExpandedChakra(expandedChakra === index ? null : index)}
                  >
                    <Icon name={expandedChakra === index ? "ChevronUp" : "ChevronDown"} className="mr-2" size={20} />
                    {expandedChakra === index ? "Скрыть" : "Подробнее"}
                  </Button>
                </CardContent>
                {expandedChakra === index && (
                  <CardContent className="pt-0 pb-8 px-8 border-t">
                    <div className="mt-6 p-6 bg-muted/50 rounded-lg">
                      <h4 className="font-heading font-bold text-xl mb-3">Что вас ждёт на занятии:</h4>
                      <p className="text-lg leading-relaxed">{chakra.details}</p>
