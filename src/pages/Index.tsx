      ...
      <section id="about" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed space-y-6">
            ...
            <p>
              Каждый класс — это полноценная практика продолжительностью 60-90 минут, включающая 
              крии, медитации, дыхательные техники и релаксацию. Вы научитесь чувствовать энергию, 
              управлять ею и использовать для трансформации жизни.
            </p>
